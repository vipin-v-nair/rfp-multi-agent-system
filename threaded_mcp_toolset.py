"""
RETAINED FOR REFERENCE ONLY. No longer used in production.

The fix implemented here was upstreamed to the ADK fork
vipin-v-nair:fix/mcp-toolset-isolated-event-loop-agent-engine and is now
available as McpToolset(use_isolated_event_loop=True). See agents/evidence.py
and agents/governance.py for the current implementation.
